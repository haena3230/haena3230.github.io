...
마음에 드는 테마가 있다면, 해당 페이지에 있는 테마 파일을 받아와야 합니다. 테마 파일을 적용하기 위한 방법은 다양하여 페이지의 사용방법을 참고해야 합니다. 주로 **다운로드 링크**, **github clone**, **fork** 등의 방법을 사용할 수 있으며, 필자는 [깔끔하고 쉽게 시작할 수 있는](https://github.com/starry99/catbook) 테마를 선택하여 fork했습니다.

...
[원본](https://www.notion.so/haena3230/ae0fcd826ffa4895a19014984cbdb0e3) 포스트를 블로그로 이동했습니다.

리액트 프로젝트를 진행하면서, 프로그래밍 방식을 더 개선할 수 있는 방법을 찾다가 알게 되었다.

- 외부 동작을 바꾸지 않으면서 **내부 구조**를 개선하는 방법이다.
- 코드가 작성된 후에 **디자인**을 개선하는 작업이다.
- 모든 것을 미리 생각하기보다는 개발을 하면서 지속적으로 좋은 디자인을 찾는다.
- 메소드 내의 지역변수와 **parameter**를 주의 깊게 볼 필요가 있다.

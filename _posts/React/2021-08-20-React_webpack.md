---
title: React webpack 기본설정
categories: [React]
comments: true
---


webpack설정에 대한 필요성이 점차 생기면서, 간단하게 기본적인 webpack 설정에 대한 내용을 정리했습니다.  

## **eject**

기본적으로 `create-react-app` 프로젝트 디렉토리를 간결하게 유지하기 위해서 웹팩 설정이나 script들의 자세한 동작을 명시한 script 폴더를 숨겨놓습니다. 하지만 숨겨진 세 설정을 커스텀해야 할 필요가 있다면 콘솔 창에

```
yarn eject
```

를 입력해 숨겨놓은 설정 파일들을 프로젝트 디렉토리에 표시되게끔 만들 수 있습니다. 다만 eject를 한 번 하면 이전 상태로 돌아갈 수 없으니 이전 내용을 git에 push하시고 신중하게 진행하셔야 합니다.
...
[다음 블로그를 참고했습니다]([https://maxkim-j.github.io/posts/cra-webpack-config](https://maxkim-j.github.io/posts/cra-webpack-config))